...
//
//     final myRequestModel = myRequestModelFromJson(jsonString);

import 'dart:convert';

MyRequestModel myRequestModelFromJson(String str) => MyRequestModel.fromJson(json.decode(str));

String myRequestModelToJson(MyRequestModel data) => json.encode(data.toJson());
